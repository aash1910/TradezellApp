/**
 * Static mapping of ISO 3166-1 alpha-2 country codes to English names.
 * Used when Intl.DisplayNames is not available (e.g. React Native / Hermes).
 */
export const COUNTRY_NAMES: Record<string, string> = {
  ...
  SZ: 'Eswatini', TA: 'Tristan da Cunha', TC: 'Turks and Caicos Islands', TD: 'Chad',
