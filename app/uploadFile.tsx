...
function resolveImageUri(value: string, baseUrl: string): string {
        ...
        <View style={styles.form}>
          ...
          >
            {isLoadingId ? (
              ...
              <Image source={{ uri: resolveImageUri(idCardImage, baseURLWithoutApi) }} style={styles.idCardImage} />
            ) : (
              <>
          ...
          >
            {isLoadingProfile ? (
              ...
              <Image source={{ uri: resolveImageUri(profileImage, baseURLWithoutApi) }} style={styles.profileImage} />
            ) : (
              <>
                <AddIcon size={15} color={COLORS.text} />
            ...
            <Text style={styles.agreementText}>
              ...
              <Text 
                ...
                onPress={() => openLegalModal(
                  'Terms of Use',
                  'Welcome to Tradezell. By using our service, you agree to these Terms of Use. Please read them carefully.\n\n1. Service Description\nTradezell is a marketplace platform for trading and selling items between users. We facilitate connections between traders but are not a party to transactions between users.\n\n2. User Accounts\nYou must be at least 18 years old to use Tradezell. You are responsible for maintaining the confidentiality of your account credentials and for all activities under your account.\n\n3. User Conduct\nYou agree to use Tradezell only for lawful purposes and in accordance with these Terms.\n\n4. Listings and Trades\nYou are responsible for the accuracy of your listings and for completing trades in good faith.\n\n5. Limitation of Liability\nTradezell is not liable for indirect, incidental, special, consequential, or punitive damages resulting from your use of the service.\n\n6. Contact\nFor questions about these Terms, please contact support through the app.'
                )}
              >
                Terms & Conditions
              </Text>
              ...
              <Text 
                ...
                onPress={() => openLegalModal(
                  'Privacy Policy',
                  'Your privacy is important to us. This Privacy Policy explains how Tradezell collects, uses, and safeguards your information.\n\n1. Information We Collect\nWe collect information you provide directly, including your name, email, phone number, profile photo, identity documents, and listing content.\n\n2. How We Use Your Information\nWe use your information to provide and improve the marketplace, verify accounts, communicate with you, and keep the platform secure.\n\n3. Information Sharing\nWe do not sell your personal information. We may share data with service providers who help us operate the platform, subject to appropriate safeguards.\n\n4. Data Security\nWe use technical and organizational measures to protect your personal information.\n\n5. Your Rights\nYou may request access, correction, or deletion of your personal information through the app or support.\n\n6. Changes\nWe may update this policy from time to time and will notify you of material changes through the app.'
                )}
              >
                Privacy Policy
              </Text>
